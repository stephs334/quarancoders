...
% Plot the rectangle aperature
figure(1)
imagesc(ap1) %plot image of the aperature field
title('Rectanglular Aperture')
colormap gray
...
l=I.^(0.05); % raise I to a power <1 to scale it
imagesc(l) % create an imagesc
title('Diffraction Pattern through a Single Slit Aperture')
colormap gray % use a gray color scale
colorbar 
xlim([0,5000]) % scale x axis
ylim([0,5000]) % scale y axis
...
l=I.^(0.05); % raise I to a power <1 to scale it
imagesc(l) % create an imagesc
title('Diffraction Pattern through a Double Slit Aperture')
colormap gray % use a gray color scale
colorbar 
xlim([0,5000]) % scale x axis
ylim([0,5000]) % scale y axis
...
eh=5;
  ...
  disp("Error occured. Please see help file for further instructions.") 
  return
