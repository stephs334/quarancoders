...
if strcmp(shape,'Rectangle')==1 % if selected shape is rectangle
    ...
    title('Horizontal Intensity Cross Section through a Rectangular Aperture')
    ...
    title('Vertical Intensity Cross Section through a Rectangular Aperture')
    xlim([0,250])
    xlabel('Pixels') % label x axis
    ylabel('W/m^2') % label y axis
...
elseif strcmp(shape,'SingleSlit')==1 % if selected shape is single slit
    ...
    plot(hit) % plot horizontal intensity cross section
    xlim([0,250])
    title('Horizontal Intensity Cross Section through a SingleSlit Aperture')
    xlabel('Pixels') % label x axis
    ylabel('W/m^2') % label y axis
...
elseif strcmp(shape,'DoubleSlit')==1 % if selected shape is double slit
    ...
    plot(hit) % plot horizontal intensity cross section
    title('Horizontal Intensity Cross Section through a DoubleSlit Aperture')
    xlim([0,250])
    xlabel('Pixels') % label x axis
    ylabel('W/m^2') % label y axis
...
elseif strcmp(shape,'Circle')==1 % if selected shape is circle
    ...
    plot(hit) % plot horizontal intensity cross section
    xlim([0,250])
    title('Horizontal Intensity Cross Section through a Circular Aperture')
    xlabel('Pixels') % label x axis
    ylabel('W/m^2') % label y axis
...
elseif strcmp(shape,'Triangle')==1 % if selected shape is triangle
    ...
    xlim([0,250])
    title('Diagonal Intensity Cross Section through a Triangular Aperture')
    ...
    xlabel('Pixels') % label x axis
    ylabel('W/m^2') % label y axis
    title('Vertical Intensity Cross Section through a Triangular Aperture')
    ...
    xlabel('Pixels') % label x axis
    ylabel('W/m^2') % label y axis
    title('Horizontal Intensity Cross Section through a Triangular Aperture')
